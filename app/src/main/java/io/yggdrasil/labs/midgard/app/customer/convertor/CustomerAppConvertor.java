...
import io.yggdrasil.labs.midgard.domain.customer.model.CompanyType;
import io.yggdrasil.labs.midgard.domain.customer.model.Customer;
import io.yggdrasil.labs.midgard.domain.customer.model.SourceType;

/**
 * CustomerAppConvertor：App 层 Cmd → Entity 转换器
 *
 * <p>负责将 App 层的 Command 转换为 Domain 层的实体
 */
@Mapper(componentModel = "spring")
public interface CustomerAppConvertor {
