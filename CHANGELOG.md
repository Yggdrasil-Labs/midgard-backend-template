...
## [1.3.0](https://github.com/Yggdrasil-Labs/midgard-backend-template/compare/v1.2.0...v1.3.0) (2026-09-21)
...
* **customer:** 添加列表搜索过滤功能及工程基础设施 ([2c64ecf](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/2c64ecf0f88034e93f520d52d1e28a5383aa8963))
...
* **adapter:** import bind exception ([e525ef5](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/e525ef5b28d0ae9f0ad4bce0c08faa3de675e9ef))
...
* 升级后端构建与可执行镜像 ([83423ca](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/83423ca83c4f12e717ee6b1ac1227d822672c428))
...
* **deps:** bump actions/checkout from 7.0.0 to 7.0.1 ([18a95e3](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/18a95e38bd288bfe8d740288c93e85c30168ce66))
* **deps:** bump actions/checkout from 7.0.0 to 7.0.1 ([c68cde0](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/c68cde0c7dbcc7f5317b60f5a9980a6a4a4e3dd3))
...
* **deps:** bump actions/setup-java from 5 to 6 ([#83](https://github.com/Yggdrasil-Labs/midgard-backend-template/issues/83)) ([036e956](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/036e9563d6fdac7d6973a2955b1b2099d2dfbb25))
...
* **deps:** bump softprops/action-gh-release from 3.0.1 to 3.0.2 ([8a00c8d](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/8a00c8d1c63a2bda56a857078b8c4410bc115494))
* **deps:** bump softprops/action-gh-release from 3.0.1 to 3.0.2 ([31092c2](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/31092c2d661f557e04c8b25b84b161b1186801ce))
* **deps:** dependabot 忽略 springdoc 3.x 主版本更新 ([076d83d](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/076d83d13812ef9aef225e286c173e47362b41a9))
...
* **deps-dev:** bump com.diffplug.spotless:spotless-maven-plugin ([#82](https://github.com/Yggdrasil-Labs/midgard-backend-template/issues/82)) ([9ed5970](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/9ed597007bebeb2d5dd53140c8f8f74a9c5aaaf3))
...
* **deps-dev:** bump com.tngtech.archunit:archunit-junit5 ([fd212e5](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/fd212e5f433f6710d768b81671ac1175916ee3f5))
...
* **deps-dev:** bump com.tngtech.archunit:archunit-junit5 from 1.4.2 to 1.5.0 ([64b4e69](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/64b4e69d78d3025efda0230af4ac311f1ae2a374))
...
* **deps-dev:** 升级 Spotless Maven 插件至 3.9.0 ([#77](https://github.com/Yggdrasil-Labs/midgard-backend-template/issues/77)) ([487601f](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/487601f574aaef3d69e5461d88d3ac2688a77ca4))
...
* **deps:** bump org.apache.maven:apache-maven from 3.9.9 to 3.9.16 ([299efd3](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/299efd336be87f872ad26aba05dae028d0381057))
* **deps:** bump org.apache.maven:apache-maven from 3.9.9 to 3.9.16 ([fedfa3d](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/fedfa3dca4b5723f7480e381e81790ad20911c38))
* **deps:** bump org.apache.maven.wrapper:maven-wrapper ([36e8d5d](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/36e8d5d03642a74b351e87eea892663b35f266c2))
* **deps:** bump org.apache.maven.wrapper:maven-wrapper from 3.3.2 to 3.3.4 ([c110c32](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/c110c32aa86ab680628d2e1fdfd75653b9895e06))
* **deps:** 升级 mimir-boot 至 2.2.0 ([ebe8347](https://github.com/Yggdrasil-Labs/midgard-backend-template/commit/ebe83479aeaab6e7ec22e2362b9247c71d065d7d))
