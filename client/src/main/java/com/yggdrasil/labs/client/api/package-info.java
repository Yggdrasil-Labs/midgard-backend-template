 ...
 *
 * <ul>
 *   <li>命名格式：{Domain}Facade
 *   <li>示例：CustomerFacade、OrderFacade、ProductFacade
 *   <li>按聚合根（Aggregate）组织，一个聚合根一个 Facade
 * </ul>
 *
 * <p><b>方法命名规则：</b>
 *
 ...
 *
 * <ul>
 *   <li>Adapter 层的 Controller 调用 Facade 接口
 *   <li>App 层实现 Facade 接口（如 CustomerFacadeImpl）
 *   <li>作为系统对外提供的业务能力边界
 * </ul>
 *
 * <p><b>注意事项：</b>
 *
 * <ul>
 *   <li>Facade 接口只定义方法签名，不包含实现
 *   <li>接口方法应清晰表达业务意图，方法名要有业务语义
 *   <li>一个 Facade 对应一个聚合根，保持接口内聚
